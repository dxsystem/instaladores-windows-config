# Script para subir las correcciones finales de carga de iconos a GitHub
# Este script sube las correcciones para asegurar que los iconos se carguen correctamente

# Configuración
$repoRoot = (Get-Location).Path
$commitMessage = "Corrección final: Asegurar que las aplicaciones se carguen antes de asignar iconos"

Write-Host "Iniciando proceso de subida de correcciones finales a GitHub..." -ForegroundColor Cyan
...
# Agregar este script
git add src/fix-icon-loading-final.ps1
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "¡Las correcciones finales se han subido correctamente a GitHub!" -ForegroundColor Green
} else {
