# Script para actualizar los cambios del servicio de iconos avanzado en GitHub
# Este script hace un pull y luego un push de los cambios

# Configuración
$repoRoot = (Get-Location).Path
$commitMessage = "Mejora: Implementación avanzada de búsqueda de iconos similar a IconService.cs"
...
# Agregar el archivo de servicio de iconos modificado
git add src/js/icon-service.js

# Agregar este script
git add src/actualizar-iconos-avanzados.ps1
